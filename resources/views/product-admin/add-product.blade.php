          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="{{route('add.submit')}}" method="post" enctype="multipart/form-data" class="tm-edit-product-form">
                @csrf
                  ...
                  <div class="form-group mb-3">
                    ...
                    >
                    @foreach ($cate as $ct)
                      <option value="{{$ct->id}}" selected>{{$ct->nameChild}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group mb-3">
