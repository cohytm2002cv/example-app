          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="{{route('createbranch')}}" method="post" class="tm-edit-product-form"
                > 
                ...
                @csrf
                  ...
                  <div class="form-group mb-3">
                    <label
                      ...
                      >phone</label
                    >
                    <input  class="form-control validate" type="text" name="phone" id="">
                  </div>
                  <div class="form-group mb-3">
                    <label
                      for="cate" name="email"
                      >Email</label
                    >
                    <input  class="form-control validate" type="text" name="email" id="">
                  </div>
                  <div class="form-group mb-3">
                    <label
                      for="cate" name="address"
                      >Địa Chỉ</label
                    >
                    <input  class="form-control validate" type="text" name="address" id="">
                  </div>
                  <div class="form-group mb-3">
                    <label
                      for="cate" name="address"
                      >Latitude</label
                    >
                    <input  class="form-control validate" type="text" name="lat" id="">
                  </div>
                  <div class="form-group mb-3">
                    <label
                      for="cate" name="address"
                      >Longitude</label
                    >
                    <input  class="form-control validate" type="text" name="long" id="">
                  </div>
