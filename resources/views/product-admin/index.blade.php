                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row"><b>{{$item->id}}</b></th>
                                    <td>
                                        <a style="color: white;font-weight:bold" href="{{ url('detail', $item->id) }}">  {{$item->Pname}}</a>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <tr>  
                                        <th> tuần thứ {{$item->week}}</th>
                                    <th scope="row"><b> {{number_format($item->revenue, 0, ',', '.')}} đồng</b></th>
                                </tr>
                                    @endforeach
